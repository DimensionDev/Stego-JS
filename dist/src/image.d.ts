...
export declare function updateImg(imageData: ImageData, block: number[], { p, c }: Loc, { size }: Options): void;
...
export declare function walkImg(imageData: ImageData, options: Options, callback: (block: number[], loc: Loc) => void): void;
