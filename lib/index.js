...
function encode(imgBuf, options) {
    return __awaiter(this, void 0, void 0, function () {
        var text, size, narrow, copies, grayscaleAlgorithm, transformAlgorithm, noClipEdgePixels, imgData, width, height, sizeOfRowBlocks, sizeOfColumnBlocks, sizeOfBlocks, textBits, bits, acc;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, canvas_1.buf2Img(imgBuf)];
                case 1:
                    imgData = _a.sent();
                    ...
                    return [2 /*return*/, canvas_2.img2Buf(imgData, noClipEdgePixels ? width : sizeOfRowBlocks * size, noClipEdgePixels ? height : sizeOfColumnBlocks * size)];
            }
        });
    });
}
...
function decode(imgBuf, options) {
    return __awaiter(this, void 0, void 0, function () {
        var size, copies, transformAlgorithm, imgData, bits, acc;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
