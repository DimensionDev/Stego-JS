...
function normalizeFlags(flags) {
    var encode = flags.encode, decode = flags.decode, size = flags.size, narrow = flags.narrow, copies = flags.copies, tolerance = flags.tolerance;
    return __assign(__assign({}, flags), { narrow: parseInt(narrow, 10), size: parseInt(size, 10), copies: parseInt(copies, 10), tolerance: parseInt(tolerance, 10), encode: encode && !decode, decode: decode });
}
...
function flags2Options(_a) {
    var _b = _a.message, message = _b === void 0 ? '' : _b, _c = _a.pass, pass = _c === void 0 ? '' : _c, narrow = _a.narrow, size = _a.size, copies = _a.copies, tolerance = _a.tolerance, grayscale = _a.grayscale, transform = _a.transform, noClipEdgePixels = _a.noClipEdgePixels;
    return {
        text: message,
        pass: pass,
        narrow: narrow,
        ...
        noClipEdgePixels: noClipEdgePixels
    };
}
