...
export declare const DEFAULT_TOLERANCE: Record<string, Record<string, number>>;
export declare const MAX_TOLERANCE: Record<string, number>;
...
export declare const DEFAULT_MASK: number[];
