...
exports.narrow = exports.shades = exports.grayscale = exports.GrayscaleAlgorithm = void 0;
...
function shades(r, g, b, size) {
    const factor = 255 / ((0, helper_1.clamp)(size, 2, 256) - 1);
    return Math.floor((r + g + b) / 3 / factor + 0.5) * factor;
}
exports.shades = shades;
function narrow(gray, size) {
    return (0, helper_1.clamp)(Math.round(gray), size, 255 - size);
}
